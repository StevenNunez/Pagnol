  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        description="Ajuste o cargo adicional sobre documentos tributarios emitidos (Tipo 56 SII)."
      />

      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Emitidos (mes)", value: "0", sub: "notas de débito" },
      ...
      <Card className="border-l-4 border-l-emerald-500 shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3">
            <CardTitle className="text-base">Notas de Débito — Tipo 56</CardTitle>
            <Badge variant="outline" className="font-mono text-xs">Tipo 56</Badge>
          </div>
        ...
        <CardContent className="flex flex-col gap-4">
          <div className="flex items-start gap-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 p-4">
            ...
            <p className="text-sm text-amber-800 dark:text-amber-300">
              La emisión de Notas de Débito (Tipo 56) estará disponible próximamente. Configure primero la integración con el SII.
            </p>
          </div>
              ...
              <TableRow>
                <TableCell colSpan={7} className="h-40 text-center">
                  <div className="flex flex-col items-center gap-3 text-muted-foreground">
                    <FilePlus className="h-14 w-14 opacity-20" />
                    <p className="text-sm">No hay notas de débito registradas.</p>
                  </div>
                </TableCell>
              </TableRow>
            </TableBody>
