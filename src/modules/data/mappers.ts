import {
    ...
    WorkItem, WorkProject, ProgressLog, PaymentState, DailyTalk, MaintenanceOrder, MaintenanceLog, EADocument,
...
export const mappers = {
    ...
    biometric_verifications: (item: any): BiometricVerification => ({
        id: item.id,
        tenantId: item.tenant_id,
        subjectUserId: item.subject_user_id ?? null,
        subjectName: item.subject_name,
        operatorUserId: item.operator_user_id ?? null,
        ...
        threshold: item.threshold != null ? Number(item.threshold) : null,
        evidencePath: item.evidence_path ?? null,
        exceptionGroupId: item.exception_group_id ?? null,
    ...
    work_projects: (item: any): WorkProject => ({
        id: item.id,
        tenantId: item.tenant_id,
        contractId: item.contract_id || null,
        name: item.name,
    ...
    work_items: (item: any): WorkItem => ({
        id: item.id,
        tenantId: item.tenant_id,
        workProjectId: item.work_project_id || null,
