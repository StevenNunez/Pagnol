...
export default function FacturasExentasPage() {
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="Facturas Exentas"
        description="Ventas y servicios no afectos o exentos de IVA (Tipo 34 SII)."
      />

      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Emitidas (mes)", value: "0", sub: "facturas exentas" },
      ...
      <Card className="border-l-4 border-l-teal-500 shadow-sm">
        <CardHeader className="flex flex-row items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3">
            <CardTitle className="text-base">Facturas Exentas — Tipo 34 SII</CardTitle>
            <Badge variant="outline" className="font-mono text-xs">Tipo 34</Badge>
          </div>
          <Button disabled className="gap-2">
            <PlusCircle className="h-4 w-4" />
            Nueva Factura Exenta
          </Button>
        </CardHeader>
          ...
          <div className="flex items-start gap-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 p-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-amber-800 dark:text-amber-300">
                La emisión de Facturas Exentas (Tipo 34) estará disponible próximamente. Solo aplica para bienes y servicios específicamente exentos por ley.
              </p>
            </div>
          </div>
              ...
              <TableRow>
                <TableCell colSpan={6} className="h-40 text-center">
                  <div className="flex flex-col items-center gap-3 text-muted-foreground">
                    ...
                    <p className="text-sm">No hay facturas exentas registradas.</p>
                  </div>
                </TableCell>
              </TableRow>
            </TableBody>
