...
export default function PaymentHistoryPage() {
    ...
    const epColumns: DataTableColumn<PaymentState>[] = [
        {
            key: 'ep', header: 'EP', className: 'font-medium',
            cell: (ep) => (
                <>
        ...
        {
            key: 'contract', header: 'Contrato', className: 'text-sm',
            cell: (ep) => ep.contractName || <span className="text-warning-subtle-foreground text-xs font-semibold">Sin contrato</span>,
        },
        {
            key: 'period', header: 'Avance del Período', headerClassName: 'text-right',
            className: 'text-right font-mono font-semibold', cell: (ep) => formatCurrency(ep.periodEarned || 0),
        },
        {
            key: 'earned', header: 'Acumulado', headerClassName: 'text-right',
            className: 'text-right font-mono text-muted-foreground', cell: (ep) => formatCurrency(ep.earnedValue),
        },
        {
        ...
        <div className="flex flex-col gap-6">
            ...
            <Card>
                ...
                <CardContent className="p-0">
                    {/* Antes: ScrollArea h-[55vh] + cabecera sticky a mano + un vacío
                        propio de 14 líneas. DataTable da las tres cosas. */}
                    <DataTable
                        data={myPaymentStates}
                        rowKey={(ep) => ep.id}
                        maxHeight="55vh"
                        columns={epColumns}
                        ...
                        empty={{
                            ...
                            description: 'Aún no has generado ningún estado de pago. Ve a un contrato y presiona "Generar Estado de Pago".',
                            action: (
